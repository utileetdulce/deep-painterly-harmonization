...
cmd:option('-index', 0)
cmd:option('-output_image', 'artifacts/out.png')

-- Other options
cmd:option('-original_colors', 0)
cmd:option('-pooling', 'max', 'max|avg')
cmd:option('-proto_file', '/storage/models/VGG_ILSVRC_19_layers_deploy.prototxt')
cmd:option('-model_file', '/storage/models/VGG_ILSVRC_19_layers.caffemodel')
